...
const Hero = () => {
    ...
    useGSAP(() => {
        ...
        tl.paused(true);
        tl.to(latestProductsRef?.current, {clipPath: 'circle(100% at 50% 55%)'})
  ...
  return (
    <section className="w-full h-[calc(100vh-150px)] flex">
        <div className="w-[55%] h-full flex flex-col justify-end text-6xl tracking-tight pb-10 relative">
            <p className="font-[900]"><span className='stretch'>POPCUL</span><span className="font-[200]">™</span><span className="font-[200]"> —</span><span className="font-[100]"> Power Of Passion</span></p>
            <p className="font-[100]">Creates Unstoppable Legends</p>
            <div className='w-full h-fit mt-20 flex justify-start gap-x-10 text-[16px] font-[200] tracking-tight text-justify'>
        ...
        <div className="w-[45%] h-full flex items-center justify-center gap-y-6 relative">
            <div ref={latestProductsButtonRef} className="w-[500px] h-[500px] rounded-full bg-white overflow-hidden relative z-50 cursor-pointer flex items-center justify-center shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]">
        ...
        <div ref={latestProductsRef} className="overlay fixed bg-white top-0 left-0 w-[100vw] h-[100vh] z-[9999]">
            <div ref={closeLatestProductsRef} className='text-black font-5xl cursor-pointer'>Soon this page will be filled with products. I am still a Work in Progress! Click me to go back ;)</div>
        </div>
    </section>
  )
}
